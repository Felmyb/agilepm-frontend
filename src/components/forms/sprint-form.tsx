      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="sprint-project">Proyecto *</Label>
              <Select value={formData.project} onValueChange={(value) => handleChange("project", value)}>
                <SelectTrigger id="sprint-project" name="project" aria-label="Proyecto" className={errors.project ? "border-destructive" : ""}>
              ...
              <input type="hidden" id="sprint-project" name="project" value={formData.project} />
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              <Label htmlFor="sprint-status">Estado</Label>
              <Select value={formData.status} onValueChange={(value) => handleChange("status", value)}>
                <SelectTrigger id="sprint-status" name="status" aria-label="Estado">
              ...
              <input type="hidden" id="sprint-status" name="status" value={formData.status} />
            </div>
