          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select value={formData.status} onValueChange={(value) => handleChange("status", value)}>
                <SelectTrigger id="task-status" name="status" aria-label="Estado">
              ...
              <input type="hidden" id="task-status" name="status" value={formData.status} />
            </div>

            <div className="space-y-2">
              <Label htmlFor="task-priority">Prioridad</Label>
              <Select value={formData.priority} onValueChange={(value) => handleChange("priority", value)}>
                <SelectTrigger id="task-priority" name="priority" aria-label="Prioridad">
              ...
              <input type="hidden" id="task-priority" name="priority" value={formData.priority} />
            </div>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select value={formData.assignedTo} onValueChange={(value) => handleChange("assignedTo", value)}>
                <SelectTrigger id="task-assignedTo" name="assignedTo" aria-label="Asignado a" className={errors.assignedTo ? "border-destructive" : ""}>
              ...
              <input type="hidden" id="task-assignedTo" name="assignedTo" value={formData.assignedTo} />
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.project} onValueChange={(value) => handleChange("project", value)}>
                <SelectTrigger id="task-project" name="project" aria-label="Proyecto" className={errors.project ? "border-destructive" : ""}>
              ...
              <input type="hidden" id="task-project" name="project" value={formData.project} />
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <Select value={formData.sprint} onValueChange={(value) => handleChange("sprint", value)}>
                <SelectTrigger id="task-sprint" name="sprint" aria-label="Sprint">
              ...
              <input type="hidden" id="task-sprint" name="sprint" value={formData.sprint} />
            </div>
